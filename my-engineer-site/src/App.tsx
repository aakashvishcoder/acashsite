  ...
  return (
    <>
      ...
      <div className="relative">
              ...
              {[1, 2].map((i) => (
                <Card key={i}>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <span className="px-2 py-1 bg-cyan-900/40 text-cyan-300 text-xs rounded">Embedded C</span>
                  </div>
                </Card>
              ))}
            </div>
        ...
        <Section id="contact">
          <Card className="max-w-wd mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-orbitron mb-6 text-cyan-300">Get In Touch</h2>
            <a
              href="mailto:aakashvish07@gmail.com"
              className="inline-block px-8 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 rounded-full font-rajdhani font-bold transition-all shadow-lg shadow-cyan-500/30 hover:shadow-cyan-400/40"
            >
              Say Hello!
            </a>
          </Card>
